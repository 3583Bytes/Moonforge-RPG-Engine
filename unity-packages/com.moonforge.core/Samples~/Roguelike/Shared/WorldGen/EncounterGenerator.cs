...
namespace Moonforge.Sample.Roguelike.WorldGen
{
    ...
    internal static class EncounterGenerator
    {
            ...
            IGameDefinitionCatalog definitions)
        {
            ...
            List<BattleActorDefinition> actors = new()
            {
                CreateHero(depth)
            };
            ...
            List<CurrencyDelta> rewardCurrency = new()
            {
            ...
            return new EncounterBlueprint(
                ...
                skills,
                rewardCurrency,
                RewardInventory: Array.Empty<InventoryDelta>(),
                championCount,
                eliteCount,
        ...
        private static BattleActorDefinition CreateHero(int depth)
        {
            ...
            return new BattleActorDefinition(
                ...
                mdef: 4 + (depth / 4),
                initiative: 20,
                skillIds: new[] { "skill.attack", "skill.potion" },
            ...
            return new BattleAiPolicyDefinition(
                rules: new[]
                {
                    new BattleAiRuleDefinition(
                        ...
                        conditions: new[] { new BattleAiConditionDefinition(BattleAiConditionType.AnyAllyHpBelowPercent, 65) }),
                    new BattleAiRuleDefinition(
                        skillId: "skill.heal",
                        priorityWeight: 90,
                        targetPolicy: BattleAiTargetPolicy.Self,
                        conditions: new[] { new BattleAiConditionDefinition(BattleAiConditionType.SelfHpBelowPercent, 40) })
                },
        ...
        {
            List<BattleAiRuleDefinition> rules = new()
            {
                new BattleAiRuleDefinition(
                    skillId: "skill.heal",
                    priorityWeight: 100,
                    targetPolicy: BattleAiTargetPolicy.Self,
                    conditions: new[] { new BattleAiConditionDefinition(BattleAiConditionType.SelfHpBelowPercent, 45) })
            };
            ...
            if (useVenomBite)
            {
                rules.Add(new BattleAiRuleDefinition(
                    ...
                    conditions: new[] { new BattleAiConditionDefinition(BattleAiConditionType.AnyEnemyHpBelowPercent, 100) }));
            }
        ...
        private static BattleActorDefinition CreateBossEnemy(BossTemplate boss, int depth, int battleSequence)
        {
            ...
            return new BattleActorDefinition(
                ...
                mdef: mdef,
                initiative: initiative,
                skillIds: new[] { "skill.boss.slam", "skill.boss.nova", "skill.boss.wreath", "skill.boss.cinderbrand", "skill.heal" },
                playerControlled: false,
            ...
            return new BattleAiPolicyDefinition(
                rules: new[]
                {
                    ...
                    new BattleAiRuleDefinition(
                        ...
                        priorityWeight: 100,
                        targetPolicy: BattleAiTargetPolicy.Self,
                        conditions: Array.Empty<BattleAiConditionDefinition>()),
                    new BattleAiRuleDefinition(
