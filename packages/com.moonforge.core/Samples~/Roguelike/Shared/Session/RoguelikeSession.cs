...
public sealed class RoguelikeSession
{
    ...
    private static PlayerAction MapTownConsoleKey(ConsoleKeyInfo key) => key.Key switch
    {
    ...
    private void EnterGearInventory()
    {
        ...
        _host.RenderContractJournal("Gear Loadout", lines, "Press 1-6 to equip/toggle, U to unequip all, Enter/Esc/I to return");
    }
    ...
    private void TickGearInventory(PlayerAction action)
    {
        switch (action)
        {
            ...
            case PlayerAction.Attack: TryUnequipAll(); return;
    ...
    private static PlayerAction MapGearInventoryConsoleKey(ConsoleKeyInfo key) => key.Key switch
    {
        ...
        ConsoleKey.U => PlayerAction.Attack,
